...
.config(function($stateProvider, $urlRouterProvider) {
      ...
      'menuContent': {
        ...
        resolve: {
          ...
          profile: function(Auth){
            ...
            return Auth.auth.$requireSignIn().then(function(auth){
  ...
  // Initialize Firebase
  var config = {
    apiKey: "AIzaSyDSkwDWrBQXwtlyrwo5LHE87MapO4_Qx50",
    authDomain: "w2emobile.firebaseapp.com",
    databaseURL: "https://w2emobile.firebaseio.com",
    storageBucket: "w2emobile.appspot.com",
  };
